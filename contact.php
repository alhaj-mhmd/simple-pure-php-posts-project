<?php $page_title = "Contact Us";  include_once 'header.php'; ?>
<?php
session_start();
...
?>
    <div class="container mb-5">
        <div class="row mt-5">
            ...
            <div class="col-sm-4">
                <!-- social -->
                <h3 class="mt-4"><i class="fab fa-facebook-f"></i>Facebook</h3> <span>https://www.facebook.com/mhd.alhajali/</span>
                  <h3 class="mt-4"><i class="fab fa-linkedin"></i>LinkedIn</h3> <span>https://www.linkedin.com/in/mohammad-alhaj-ali/</span>
            </div>
            <div class="col-sm-4">
                <!-- address -->
